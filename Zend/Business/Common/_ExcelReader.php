...
/*
* @return Business_Common_ExcelReader
*/
class Business_Common_ExcelReader extends Business_Abstract {
	 ...
	 */
	function Business_Common_ExcelReader($file='',$store_extended_info=true)
	{
