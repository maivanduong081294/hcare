...
class Business_Addon_ProductsRating extends Business_Abstract
{
	private $_tablename = 'addon_products_rating';
        
        const KEY_DETAIL = 'addon.products.rating.detail.%s';
	...
	/**
	 * get instance of Business_Addon_ProductsRating
	 *
	 * @return Business_Addon_ProductsRating
	 */
	public static function getInstance()
	{
		if(self::$_instance == null)
		{
			self::$_instance = new Business_Addon_ProductsRating();
		}
