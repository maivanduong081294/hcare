...
class Business_Addon_Department extends Business_Abstract {

    private $_tablename = 'department';

    const KEY_LIST = 'department.list.%s';   //key of list.questionid
    const KEY_DETAIL = 'department.detail.%s';  //key of detail.id
    const KEY_DETAIL_KM = 'km.%s';  //key of detail.id
    const KEY_DETAIL_LIST_KM = 'getlist_department.%s';  //key of list.id
    ...
    /**
     * get instance of Business_Addon_Department
     *
     * @return Business_Addon_Department
     */
