...
class Business_Addon_Delegate extends Business_Abstract {

    private $_tablename = 'hnam_delegate';
    ...
    /**
     * get instance of Business_Addon_Delegate
     *
     * @return Business_Addon_Delegate
     */
    ...
    public function getList($departmentid=0,$storeid=0,$month,$year,$orderby=0){
        $db= $this->getDbConnection();
