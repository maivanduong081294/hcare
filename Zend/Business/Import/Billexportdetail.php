...
class Business_Import_Billexportdetail extends Business_Abstract
{
	private $_tablename = 'import_bill_export_detail';
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_Billexportdetail();
		}
