...
class Business_Import_Billmain extends Business_Abstract
{
	private $_tablename = 'import_bill_main';
	...
	/**
	 * get instance of Business_Import_Billmain
	 *
	 * @return Business_Import_Billmain
	 */
	public static function getInstance()
	{
		if(self::$_instance == null)
		{
			self::$_instance = new Business_Import_Billmain();
		}
