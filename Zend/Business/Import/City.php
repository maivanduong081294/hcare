...
class Business_Import_City extends Business_Abstract
{
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_City();
		}
	...
	public function getList()
	{
        ...
        $query = "select * from " . $this->_tablename . " where countryid = 1 order by id desc";
