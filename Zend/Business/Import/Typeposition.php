...
class Business_Import_Typeposition extends Business_Abstract
{
	private $_tablename = 'import_typeposition';
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_Typeposition();
		}
	...
	{
        $db = $this->getDbConnection();
        $query = "select * from " . $this->_tablename . " where id_parent = 0 order by id desc";
        $result = $db->fetchAll($query);
        return $result;
	}
	...
	{
        $db = $this->getDbConnection();
        $query = "select * from " . $this->_tablename . " where id_parent = ".$id_parent." order by id desc";
        $result = $db->fetchAll($query);
        return $result;
	}
