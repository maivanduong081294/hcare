...
class Business_Import_Cateproduct extends Business_Abstract
{
	private $_tablename = 'import_cateproduct';
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_Cateproduct();
		}
	...
	public function getList()
	{
        ...
        $query = "select * from " . $this->_tablename . " where 1 order by id asc";
