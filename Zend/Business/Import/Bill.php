...
class Business_Import_Bill extends Business_Abstract
{
	private $_tablename = 'import_bill';
	...
	/**
	 * get instance of Business_Import_Bill
	 *
	 * @return Business_Import_Bill
	 */
	public static function getInstance()
	{
		if(self::$_instance == null)
		{
			self::$_instance = new Business_Import_Bill();
		}
