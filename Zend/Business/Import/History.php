...
class Business_Import_History extends Business_Abstract
{
	private $_tablename = 'import_history';
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_History();
		}
	...
	public function getList($offset = 0, $records = 10, $field = '')
	{
        ...
        $query .= " order by id desc limit $offset, $records";
        $result = $db->fetchAll($query);
        return $result;
	}
