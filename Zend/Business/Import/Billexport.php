...
class Business_Import_Billexport extends Business_Abstract
{
	private $_tablename = 'import_bill_export';
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_Billexport();
		}
	...
	public function getWhere($field_where,$val_where, $field = "*")
	{
            $id = intval($id);
            $db = $this->getDbConnection();
