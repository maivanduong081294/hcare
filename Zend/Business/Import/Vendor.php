...
class Business_Import_Vendor extends Business_Abstract
{
	private $_tablename = 'import_vendor';
	...
	/**
	 * get instance of Business_Import_Vendor
	 *
	 * @return Business_Import_Vendor
	 */
	public static function getInstance()
	{
		if(self::$_instance == null)
		{
			self::$_instance = new Business_Import_Vendor();
		}
	...
	public function getWhere1($where_field,$where_value, $field = "*")
	{
            $id_type = intval($id_type);
            $db = $this->getDbConnection();
            $query = " SELECT ".$field." FROM " . $this->_tablename ." WHERE ".$where_field." = ?";
	...
	public function getWhereByIdtype($id_type, $field = "*")
	{
            $id = intval($id);
            $db = $this->getDbConnection();
