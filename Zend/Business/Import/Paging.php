...
//                static $_next_button = '<img src="/images/data/icon-next.gif" align="absmiddle"/>';
    ...
    public static function getInstance() {
        if (self::$_instance == null) {
            self::$_instance = new Business_Import_Paging();
        }
    ...
    public static function doPaging($curpage, $total_records, $url, $pagerange = 5, $template = "tg",$id_program = '',$used = '') {
        //die('nn');
        if ($total_records == 0)
            $total_records = 1;
        ...
        if ($template != 'tg' && $template != 'pos' && $template != 'his') {
        ...
        if ($template == "hnam") {
            ...
            $view->setBasePath(APPLICATION_PATH . "/modules/import/views", "phtml");
            if ($template == '')
            ...
            elseif ($template == 'bella') {
                ...
                elseif ($template == 'pos') {
                $content = $view->render('paging/paging_template_position.phtml');
            }
            elseif ($template == 'his') {
                $content = $view->render('paging/paging_template_history.phtml');
            } else {
