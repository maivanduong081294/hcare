...
class Business_Import_Billimportdetail extends Business_Abstract
{
	private $_tablename = 'import_bill_import_detail';
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_Billimportdetail();
		}
