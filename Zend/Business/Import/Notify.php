...
class Business_Import_Notify extends Business_Abstract
{
	...
	public static function getInstance()
	{
		...
		{
			self::$_instance = new Business_Import_Notify();
		}
	...
	public function getWhereByParentID($parentid, $field = "*")
	{
            $id = intval($parentid);
            $db = $this->getDbConnection();
            $query = " SELECT ".$field." FROM " . $this->_tablename ." WHERE inventory_import = ?";

// if($_REQUEST["d"]==1) {
// 	var_dump($query,$parentid);die();
// }
